...
<!--                        <a href="<?php echo $CFG->wwwroot; ?>/user/editadvanced.php"><li><img src="<?php echo $OUTPUT->pix_url('profile/editprofile', 'theme')?>" />&nbsp;<?php echo get_string('editmyprofile');?></li></a> -->
			...
			<?php if ($hasemailurl) {?><a href="<?php echo $PAGE->theme->settings->emailurl;?> "><li><img src="<?php echo $OUTPUT->pix_url('profile/email', 'theme')?>" />&nbsp;<?php echo get_string('email','theme_krystle');?></li></a> <?php } else {}?>
