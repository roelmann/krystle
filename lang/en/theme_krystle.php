...
//language strings brought across from Zebra settings
...
//language strings brought across from aardvark profilebar settings
$string['email'] = 'Email';
...
//Box slider settings language strings
